...
$enc = [System.Text.Encoding]::ASCII # Sets the encoding to ASCII

[Byte[]]$key = $enc.GetBytes("Q0mmpr4B5rvZi3pS") # Key used for encryption/decryption
...
$DecryptedBytes = encr $data $key # Decrypts the bytes
$DecryptedString = $enc.GetString($DecryptedBytes) # Converts into readable text
Write-Output $DecryptedString # Writes the decrypted string
